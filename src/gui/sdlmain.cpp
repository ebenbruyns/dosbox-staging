...
// 'set_window_resize_handler' either adds or removes the window resize handler
// to or from SDL's event system. It should be removed prior to making any
// significant window or rendering modifications.
//
