...
constexpr auto MasterChannelName        = "MASTER";
...
enum class ErrorType {
	...
	InvalidSetChorusLevelCommand,
	InvalidSetCrossfeedStrengthCommand,
	InvalidSetReverbLevelCommand,
	InvalidSetStereoModeCommand,
